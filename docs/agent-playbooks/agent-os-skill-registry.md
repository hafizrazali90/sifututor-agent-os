...
| `$weekly-delivery` | Weekly Delivery | Reporting what shipped, what remains in progress, blockers, decisions, and collection coverage for a week. | `.agents/skills/weekly-delivery/SKILL.md` | `docs/agent-playbooks/weekly-delivery-report.md` | `/weekly-report` adapter to the shared playbook | Individual rankings, productivity scores, or publishing partial data. |
