...
| Runtime reliability | AO-151, AO-152, AO-153, AO-154 | Partly covered by response-shape and conversation fixtures. Full checks need real session state, active Session Map, route context, and current Git evidence. The runtime playbook defines the behavior now. |
