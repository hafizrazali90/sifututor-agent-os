...
| --- | --- | --- |
| Communication style | AO-032, AO-033, AO-034, AO-035, AO-064, AO-070, AO-175 | Partly covered by the response-shape runner, including practical meaning, state, next action, decision needed, formal-label translation, and deterministic copy-ready message formatting. Full tone and content judgment still needs human review. |
