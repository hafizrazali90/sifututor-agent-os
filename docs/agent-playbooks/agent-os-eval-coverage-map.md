...
2. Add connector-specific live read probe for production-log availability when
   a stable safe check exists.
3. Add an app-tool live-read fixture for Google Drive when Codex can call the
