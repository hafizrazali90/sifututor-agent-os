...
| Verify, QA, and evidence | AO-016, AO-017, AO-028, AO-059, AO-060, AO-099, AO-100 | Asking Hafiz to check what the agent can safely test, calling machine proof enough for a human workflow, saying ready without naming evidence level reached, or hiding a missing-proof gap inside a vague manual check. |
