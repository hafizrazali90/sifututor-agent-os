...
| Planning, product design, document production, and presentations | How vague ideas become understandable build work, how substantial professional documents move from research to governed local outputs, and how approved stories become web-native slide decks. | `planning-artifacts.md`, `product-design.md`, `document-production.md`, `frontend-slides.md`, `ai-implementation-readiness.md` |
...
| Research and history | Why decisions were made or what happened in old sessions. | `agent-os-research.md`, `agent-os-omnigent-foundation-fit-test.md`, `agent-os-review-roadmap.md`, session-save docs, parity/status reports |
...
| "Create a professional sourcebook, strategy paper, or stakeholder document" | `document-production.md` | document contract, deep research, claim register, blueprint approval, local formats, adversarial review |
| "Create, convert, redesign, or render an HTML slide presentation" | `frontend-slides.md` | assertion storyboard, visual direction, fixed-stage HTML, local export, slide-level visual QA |
...
| Planning, document production, and implementation readiness | `planning-artifacts.md`, `product-design.md`, `document-production.md`, `ai-implementation-readiness.md`, `agent-os-workflows.md` |
...
| Research and roadmap | `agent-os-research.md`, `agent-os-omnigent-foundation-fit-test.md`, `agent-os-review-roadmap.md`, `parity-status.md`, `claude-codex-parity-implementation-report.md`, `commit-plan.md`, `lls-workflow-migration.md`, `workflow-rollout-cleanup.md`, `README.md` |
