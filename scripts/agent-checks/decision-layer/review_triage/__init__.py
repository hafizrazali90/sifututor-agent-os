...
Status: advisory only, not wired into any skill, playbook, guard or CI job,
and exercised only against the offline fake provider. See the "Status"
paragraph in `triage.py` before treating any output as evidence.
